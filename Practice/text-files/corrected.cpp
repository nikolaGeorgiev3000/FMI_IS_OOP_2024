...
void replace_in_text(const char* filename, const char* to_replace,
    ...
    std::ofstream o_file("../FMI_IS_OOP_2024/Practice/text-files/corrected.cpp",
                         std::ios::trunc); // Open/create the file `corrected.cpp`, with over-writing option.
...
int main() {
    replace_in_text("../FMI_IS_OOP_2024/Practice/text-files/replaceInTextFile.cpp", "double", "int");
